...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    return(
      ...
      <header className="flex items-center h-14 px-4 border-b gap-4 lg:h-20 dark:border-gray-800">
                ...
                <div className="grid md:grid-cols-[1fr_2fr]">
                  <div className="flex flex-col items-start p-4 gap-2 md:items-center md:gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      {data ? (<div className="text-2xl font-semibold">${data.c}</div>) : (<div>loading...</div>)}
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="font-semibold">24h Change</div>
                      {data ? (<div className="text-green-500">{data.P}%</div>) : (<div>loading...</div>)}
                    </div>
                  </div>
                  <div className="grid gap-4 p-4 md:grid-cols-[2fr_1fr]">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {data ?(<div className="ml-auto">${data.h}</div>) : (<div>loading...</div>)}
                    </div>
                    <div className="flex items-center gap-4">
                      <div className="font-semibold">Low</div>
                      {data ? (<div className="ml-auto">${data.l}</div>) : (<div>loading...</div>)}
                    </div>
                  </div>
                </div>
              </CardContent>
